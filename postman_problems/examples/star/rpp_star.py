...
def main():
    ...
    try:
        ...
        plot_circuit_graphviz(
            ...
            format="svg",
            engine="circo",
            graph_attr={"label": "Base Graph: Chinese Postman Solution (required edges only)", "labelloc": "t"},
        )
        ...
        plot_circuit_graphviz(
            ...
            format="svg",
            engine="circo",
            graph_attr={"label": "Base Graph: Chinese Postman Solution (required & optional edges)", "labelloc": "t"},
        )
        ...
        make_circuit_images(circuit=circuit_rpp, graph=graph_rpp, outfile_dir=PNG_PATH, format="png", engine="circo")

        logger.info("Creating GIF")
        make_circuit_video(infile_dir_images=PNG_PATH, outfile_movie=RPP_GIF_FILENAME, fps=1)
